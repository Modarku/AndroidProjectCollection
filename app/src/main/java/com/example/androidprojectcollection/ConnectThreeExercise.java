...
import com.example.androidprojectcollection.classes.BitBoard;
import com.example.androidprojectcollection.databinding.ActivityConnectThreeExerciseBinding;
...
public class ConnectThreeExercise extends AppCompatActivity {

    private ActivityConnectThreeExerciseBinding binding;

    @SuppressLint("UseCompatLoadingForDrawables")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityConnectThreeExerciseBinding.inflate(getLayoutInflater());
    ...
    void cellBtnClick(int cellRow, boolean[] gameState, int[] ctr, ArrayList<Integer> mainBitBoard, ArrayList<TextView> cells){
        ...
        if(gameState[0]){
            ...
            if(ctr[cellRow] < 5){
                ...
                Toast.makeText(ConnectThreeExercise.this, "Row " + cellRow + " 0 is full!", Toast.LENGTH_SHORT).show();
            }
        }else{
            //append tile
            if(ctr[cellRow] < 5){
                ...
                Toast.makeText(ConnectThreeExercise.this, "Row " + cellRow + " is full!", Toast.LENGTH_SHORT).show();
            }
            gameState[0] = true;
        }
